                ...
                if new_data:
                    ...
                    while True:
                        ...
                        if logical_frame is not None:
                            ...
                            HIGH_ZONE_THRESHOLD = 0.90
                            LOW_ZONE_THRESHOLD = 0.10
                            if previous_logical_frame > total_frames_per_cycle * HIGH_ZONE_THRESHOLD and \
                                    logical_frame < total_frames_per_cycle * LOW_ZONE_THRESHOLD:
                                cycle_counter += 1
                                print(f"费用条循环完成! 新计数值: {cycle_counter}")
