...
/// Cost bar ROI: (x1, x2, y_mid)
pub type Roi = (i32, i32, i32);

/// Calculate the cost bar ROI based on screen resolution.
/// Returns (x1, x2, y_mid) - the horizontal pixel range and vertical scan line.
...
mod tests {
    ...
    fn test_roi_1080p() {
        ...
        // x1 = 1920 - 181*1.0 = 1739, x2 = 1920 - 1*1.0 = 1919
        assert_eq!(x1, 1739);
        assert_eq!(x2, 1919);
        // y = (1080-270+1080-263)/2 ≈ 814
    ...
    fn test_roi_720p() {
        ...
        // At 720p, scale = 720/1080 = 0.667
        // x1 = 1280 - 181*0.667 ≈ 1159, x2 = 1280 - 1*0.667 ≈ 1279
